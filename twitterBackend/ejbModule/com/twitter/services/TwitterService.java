...
public class TwitterService implements ITwitter {
	...
	private Twitter getInstance() {
		...
		cb.setDebugEnabled(true)
		  .setOAuthConsumerKey("KnqQbON7dPDhpwjORjcxvdRkD")
		  .setOAuthConsumerSecret("ZxS4QcEY8CmSsLkAh8pHgA9fY2FoId6gBv9Abq2gN8rwVHkeFQ ")
		  .setOAuthAccessToken("487371147-PELXSoaB3dPxmZ0tuB3Rooi8sOo66N6HupKWNnl0")
		  .setOAuthAccessTokenSecret("9WFwLeofVk3jjHXJqYLVfvtGwxSGKOm2bnpopNBA0Zgof");
